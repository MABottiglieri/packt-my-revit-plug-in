...
namespace myApp
{
    public class RibbonBar
    {
        ...
        private void addRibbonBar(UIControlledApplication application)
        {
            ...
            AddPushButtonWithImage(panel, mypath, "button1", " Text ", "myApp.Command1", @"C:\Users\manue\source\repos\packt-my-revit-plug-in\myApp\bin\Debug\icon-dialog_32x32.png");
            AddPushButtonWithImage(panel, mypath, "button2", " Web Request ", "myApp.Command2", @"C:\Users\manue\source\repos\packt-my-revit-plug-in\myApp\bin\Debug\icon-web_32x32.png");
            
            // Create a panel with 1 image button
            RibbonPanel imagePanel = application.CreateRibbonPanel(tabName, "Model Data");
            AddPushButtonWithImage(imagePanel, mypath, "button3", "collect", "myApp.Command3", @"C:\Users\manue\source\repos\packt-my-revit-plug-in\myApp\bin\Debug\icon-get_32x32.png");
            AddPushButtonWithImage(imagePanel, mypath, "button4", "send", "myApp.Command4", @"C:\Users\manue\source\repos\packt-my-revit-plug-in\myApp\bin\Debug\icon-send_32x32.png");
        }
